...
class TelnetClient {
     ...
     */
    public function __construct( $host = '172.16.13.242', $port = 23, $timeout = 10, $prompt = '$', $err_prompt = 'ERROR' ){
        $this->host = $host;
        $this->port = $port;
     ...
     * @throws TelnetException
     */
    public function login( $username, $password, $usernamePrompt = 'login:', $passwordPrompt = 'Password:', $loggedPrompt = '#' ){
